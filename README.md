...
│  /plan:hard [feature]                                               │
│       ↓                                                             │
│  /code phase-01/core.md → /docs:sync                               │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
│   │   ├── lean.md                  # /lean
│   │   └── ipa/
│   │       ├── spec.md              # /ipa:spec (New Stage 1)
│   │       ├── design.md            # /ipa:design (Stage 2)
│   │       ├── detail.md            # /ipa:detail (New Stage 3)
│   │       ├── init.md              # /ipa:init
...
**Changes:**
- Converted agents to skills to resolve global CK conflicts
- Introduced `/ipa:spec` and `/ipa:detail` for clearer stages
- Added Validation Gates (GATE 1/2/3) with checklists
- Enhanced `/lean` with Phase Breakdown and Gate 1
- Updated directory structure to reflect skill-based architecture
