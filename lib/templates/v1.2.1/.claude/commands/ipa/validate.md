...
Check gate completion status:

### GATE 1: Scope Validation (after /lean)
- [ ] 3+ user interviews completed
- [ ] Scope ≤ 3 phases
- [ ] Assumptions documented
- [ ] MVP scope clearly defined

### GATE 2: Spec Validation (after /ipa:spec)
- [ ] Stakeholders reviewed SRD
- [ ] Priorities confirmed (P1/P2/P3)
- [ ] Scope matches /lean output
- [ ] All FR-xx have clear acceptance criteria

### GATE 3: Design Validation (after /ipa:design)
- [ ] 5+ user testing sessions
- [ ] Usability issues addressed
- [ ] Design matches MVP scope
- [ ] All S-xx screens prototyped

**Enforcement:** Soft (warning only)

**Note:** Gates can be skipped with `--skip-gate` flag, but this is logged as a warning in the validation report.

**Skip Syntax:**
```bash
/ipa:validate --skip-gate
```
